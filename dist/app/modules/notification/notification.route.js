...
notification_controller_1.NotificationControllers.createNotification);
...
// auth("admin", "director", "company", "creator", "user"),
notification_controller_1.NotificationControllers.markAsRead);
router.patch("/readall", 
// auth("admin", "director", "company", "creator", "user"),
notification_controller_1.NotificationControllers.markAllAsRead);
